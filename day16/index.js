...
function Section() {
    ...
    return (
        <div className="section">
            <div className='form'>
                <input type='text' name="topText" className="form--input" placeholder="Top text" onChange={handleChange} value={meme.topText}></input>
                {/* <label htmlFor="input1"></label> */}
                <input type='text' name="bottomText" className="form--input" placeholder="Bottom text" onChange={handleChange} value={meme.bottomText}></input>
                {/* <label htmlFor="input2"></label> */}
                <button onClick={getMemeImage} type="submit" name="submit" className='form--submit'>Get a new meme image</button>
            </div>
            <div className="meme">
