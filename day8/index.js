...
function Section() {
    ...
    function getMemeImg() {
        ...
        setImg(memesArray[randomNum].url)
    }
    ...
    return (
        <div className="section">
            <div className='section--form'>
                ...
                <button onClick={getMemeImg} type="submit" name="submit" className='form--submit'>Get a new meme image</button>
            </div>
            <img src={memeImg} className="section--memeImg"></img>
        </div>
    )
}
